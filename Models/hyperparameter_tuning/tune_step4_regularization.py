...
def run_regularization_tuning(X_train, X_val, y_train, y_val, base_params, n_trials, parent_run_id, random_state=42):
    ...
    study_name = "step4_regularization_optimization"
    ...
    logging.info(f"Best trial for regularization tuning: {study.best_trial.value}")
    logging.info(f"Best parameters for regularization tuning: {study.best_params}")
